...
export namespace Types {
     ...
     */
    export interface SettingGetDetailsType {
     ...
     */
    export interface SettingGetCallbackDetailsType {
     ...
     */
    export interface SettingSetDetailsType {
     ...
     */
    export interface SettingClearDetailsType {
