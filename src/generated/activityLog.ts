...
export namespace ActivityLog {
    export interface OnExtensionActivityDetailsType {
     ...
     * The type of log entry.  api_call is a function call made by the extension and api_event is an event callback to the extension.  content_script is logged when a content script is injected.
     */
    export type OnExtensionActivityDetailsTypeTypeEnum = "api_call" | "api_event" | "content_script" | "user_script";

    /**
     * The type of view where the activity occurred.  Content scripts will not have a viewType.
     */
    export type OnExtensionActivityDetailsTypeViewTypeEnum = "background" | "popup" | "sidebar" | "tab" | "devtools_page" | "devtools_panel";

    /**
     * The result of the call.
     */
    export interface OnExtensionActivityDetailsTypeDataResultType {
    }

    export interface OnExtensionActivityDetailsTypeDataType {
     ...
     */
    export interface onExtensionActivityEvent extends Events.Event<(details: OnExtensionActivityDetailsType) => void> {
