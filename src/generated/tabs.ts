...
export namespace Tabs {
    ...
    export interface HighlightHighlightInfoType {
    ...
    export interface ReloadReloadPropertiesType {
    ...
    export interface OnSelectionChangedSelectInfoType {
    ...
    export interface OnActiveChangedSelectInfoType {
    ...
    export interface OnHighlightChangedSelectInfoType {
    ...
    export interface OnHighlightedHighlightInfoType {
    ...
    export interface OnDetachedDetachInfoType {
        oldWindowId: number;

        oldPosition: number;
    }

    export interface OnAttachedAttachInfoType {
        newWindowId: number;

        newPosition: number;
    }

    export interface OnRemovedRemoveInfoType {
    ...
    export interface OnZoomChangeZoomChangeInfoType {
        tabId: number;
