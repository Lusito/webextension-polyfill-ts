...
export namespace History {
    ...
    export interface GetVisitsDetailsType {
    ...
    export interface AddUrlDetailsType {
    ...
    export interface DeleteUrlDetailsType {
    ...
    export interface DeleteRangeRangeType {
    ...
    export interface OnVisitRemovedRemovedType {
    ...
    export interface OnTitleChangedChangedType {
