...
export namespace WebNavigation {
     ...
     */
    export interface GetFrameDetailsType {
     ...
     */
    export interface GetAllFramesDetailsType {
    ...
    export interface OnCommittedDetailsType {
    ...
    export interface OnDOMContentLoadedDetailsType {
    ...
    export interface OnCreatedNavigationTargetDetailsType {
    ...
    export interface OnReferenceFragmentUpdatedDetailsType {
    ...
    export interface OnTabReplacedDetailsType {
    ...
    export interface OnHistoryStateUpdatedDetailsType {
     ...
     */
    export interface onBeforeNavigateEvent extends Events.Event<(details: OnBeforeNavigateDetailsType) => void> {
     ...
     */
    export interface onCommittedEvent extends Events.Event<(details: OnCommittedDetailsType) => void> {
     ...
     */
    export interface onDOMContentLoadedEvent extends Events.Event<(details: OnDOMContentLoadedDetailsType) => void> {
     ...
     */
    export interface onCreatedNavigationTargetEvent extends Events.Event<(details: OnCreatedNavigationTargetDetailsType) => void> {
     ...
     */
    export interface onReferenceFragmentUpdatedEvent extends Events.Event<(details: OnReferenceFragmentUpdatedDetailsType) => void> {
     ...
     */
    export interface onHistoryStateUpdatedEvent extends Events.Event<(details: OnHistoryStateUpdatedDetailsType) => void> {
