...
export namespace Downloads {
     ...
     */
    export type DownloadTime = string | ExtensionTypes.DateType;
    ...
    export interface OnChangedDownloadDeltaType {
     ...
     * The HTTP method to use if the URL uses the HTTP[S] protocol.
     */
    export type DownloadOptionsTypeMethodEnum = "GET" | "POST";

    export interface DownloadOptionsTypeHeadersItemType {
